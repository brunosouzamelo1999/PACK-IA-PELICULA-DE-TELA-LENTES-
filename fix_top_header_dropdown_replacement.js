...
console.log('Successfully inserted header-center-menu into apresentacao_frame.html!');
...
console.log('Successfully inserted header-center-menu into apresentacao_board.html!');
